...
- **소개**: [https://terms.kr/#/about](https://terms.kr/#/about)
- **사용법**: [https://terms.kr/#/guide](https://terms.kr/#/guide)
- **운영 및 기여 조직**: [https://terms.kr/#/organizations](https://terms.kr/#/organizations)
...
- 코드를 몰라도 [GitHub Issue](https://github.com/PyTorchKR/terms-kr/issues)를 통해 새로운 용어 추가, 번역 개선, 오류 수정 등을 제안할 수 있습니다.

## LLM / AI 번역 도구 연동

이 용어집은 사람뿐 아니라 AI 도구에서도 활용할 수 있도록 기계 판독 가능한 형식을 제공합니다:

- **[llms.txt](https://terms.kr/llms.txt)**: [llmstxt.org](https://llmstxt.org/) 표준에 따른 LLM용 프로젝트 안내 파일
- **[AGENTS.md](AGENTS.md)**: [agents.md](https://agents.md/) 표준에 따른 AI 코딩 에이전트용 프로젝트 가이드
- **[JSON 데이터](https://terms.kr/data/)**: 알파벳별 JSON 파일로 전체 용어 데이터에 접근 가능 (`data/index.json`에서 파일 목록 조회)
...
- [새 용어 요청](https://github.com/PyTorchKR/terms-kr/issues/new?template=new-term.yml)
- [용어 피드백 (번역 개선 등)](https://github.com/PyTorchKR/terms-kr/issues/new?template=term-feedback.yml)
- [조직 참여 신청](https://github.com/PyTorchKR/terms-kr/issues/new?template=organization-join.yml)
...
- `npm run dev`와 `npm run build` 실행 전 `scripts/sync-public-data.mjs`가 `data/`를 `public/data/`로 복사합니다. 배포 후에는 `https://terms.kr/data/index.json` 및 각 알파벳 JSON으로 접근할 수 있습니다.
...
- 새 조직은 [조직 참여 신청 이슈](https://github.com/PyTorchKR/terms-kr/issues/new?template=organization-join.yml)로 참여 의사를 남길 수 있습니다.
